<template>
  <div class="container">
    ...
    <!--          <img class="d-block w-100" v-bind:src="`${slide.image}`" alt="">-->
    <!--          <div class="link">-->
    <!--            <a v-bind:href="`${slide.link}`">{{slide.text}}</a>-->
    <!--          </div>-->
    <!--        </div>-->
    <!--      </div>-->
    ...
    <vueper-slides
      ...
      <vueper-slide
        ...
        <template v-slot:content>
          <a class="search-link btn btn-primary" v-bind:href="`${slide.link}`">{{ slide.text }}</a>
        </template>
      </vueper-slide>
    </vueper-slides>
